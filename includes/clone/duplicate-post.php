...
// i18n plugin domain
define('pspin_duplicate_post_I18N_DOMAIN', 'duplicate-post');

// Version of the plugin
define('pspin_duplicate_post_CURRENT_VERSION', '2.4.1' );

/**
 * Initialise the internationalisation domain
 */
load_plugin_textdomain(pspin_duplicate_post_I18N_DOMAIN,
			'wp-content/plugins/duplicate-post/languages','duplicate-post/languages');

add_filter("plugin_action_links_".plugin_basename(__FILE__), "pspin_duplicate_post_plugin_actions", 10, 4);

function pspin_duplicate_post_plugin_actions( $actions, $plugin_file, $plugin_data, $context ) {
